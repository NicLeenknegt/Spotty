...
var scopes=[
	"user-read-playback-state", // Read access to a user's playstate
	...
	"streaming" // control playback of a Spotify track, used for Web playback SDK
]

var getAuthentorizarionScopes = function () {
	var scope = '';
...
app.get('/login', function(req, res) {
  ...
  var scope = getAuthentorizarionScopes();
